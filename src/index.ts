...
import { registerPersonTools, registerCompanyTools, registerTaskTools, registerOpportunityTools, registerActivityTools, registerMetadataTools, registerRelationshipTools, registerIsLeadTools } from './tools/index.js';
...
async function main() {
  ...
  registerIsLeadTools(server, client);
